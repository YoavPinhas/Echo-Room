...
public class ArduinoMnager : MonoBehaviour
{
    ...
    {
        _arduino.toggle_output_state(index- outputStart);
        _arduino.send_output_state();
    ...
    private void CheckInputs()
    {
        ...
        {
            bool temp = _arduino.get_input_state(i);
    ...
    public void ChangeOutputState(int index, bool state)
    {
        ...
        if (_arduino == null)
            return;
        _arduino.set_output_state(index - outputStart, state);
        _arduino.send_output_state();
    }
